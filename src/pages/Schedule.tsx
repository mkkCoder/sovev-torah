      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="paper rounded-3xl p-5">
          ...
          <input
            ...
            className="mt-1 w-28 rounded-xl border border-mist bg-parchment px-3 py-2"
          />
          <div className="mt-4 rounded-2xl bg-parchment p-4">
            ...
            <div className="mt-2 flex gap-3">
              <label className="text-sm">
                ...
                <input
                  type="number"
                  className="ms-2 w-16 rounded border border-mist px-2 py-1"
        ...
        <section className="paper rounded-3xl p-5">
          ...
          <div className="mt-3 space-y-2">
            {state.weekly.map((row) => (
              <div key={row.day} className="grid grid-cols-12 items-center gap-2 rounded-xl bg-parchment/70 px-3 py-2">
                <div className="col-span-2 text-sm font-semibold">{DAY_NAMES[row.day]}</div>
                <select
                  className="col-span-3 rounded-lg border border-mist bg-card px-2 py-1 text-sm"
                  value={row.category}
                  onChange={(e) => {
                ...
                <select
                  className="col-span-4 rounded-lg border border-mist bg-card px-2 py-1 text-sm"
                  value={row.seferId}
                  onChange={(e) => {
...
function BookProgress() {
  const state = useAppState();
  return (
    <section className="mt-6 paper rounded-3xl p-5">
