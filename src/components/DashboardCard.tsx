...
export function DashboardCard({
  ...
  return (
    <Link
      to={to}
      className={`lift paper relative flex min-h-[132px] min-w-0 flex-col justify-between overflow-hidden rounded-[1.45rem] p-4 sm:min-h-[168px] sm:p-5 ${
    ...
    >
      ...
      <div>
        <h2 className="font-display text-[1.3rem] leading-tight text-ink sm:text-[1.65rem]">{title}</h2>
